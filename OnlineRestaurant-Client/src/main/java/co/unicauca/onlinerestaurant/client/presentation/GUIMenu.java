...
public class GUIMenu extends javax.swing.JFrame {
    ...
    private void ponerUsuarioLogueado() {
        ...
        if (co.unicauca.onlinerestaurant.client.infra.Security.usuario == null) {
            this.mnuEmpleadoLogueado.setText("(Anónimo)");
        } else {
            this.mnuEmpleadoLogueado.setText("(" + co.unicauca.onlinerestaurant.client.infra.Security.usuario.getLogin() + ")");
        }
    ...
    private void mnuAcercaDeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuAcercaDeActionPerformed
        // TODO add your handling code here:
        String str = "Online Restaurant demo \n"
                + "Version 0.1 - Julio 23 de 2020 \n"
